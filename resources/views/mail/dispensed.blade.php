...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <body style="background-color: #BEBEBE;" data-new-gr-c-s-check-loaded="14.1122.0" data-gr-ext-installed="">
        <div style="background-color: #BEBEBE;">
                                            ...
                                            <tr>
                                                <td align="left" style="font-size: 0px; padding: 10px 25px; word-break: break-word;">
                                                    <div style="font-family: Montserrat, Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 24px; text-align: left; color: black;">
                                                        <h1 style="margin: 0; font-size: 46px; line-height: 60px; font-weight: 600; font-family: 'Inknut Antiqua', Helvetica, Arial, sans-serif;">Thank you for donating your blood</h1>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left" style="font-size: 0px; padding: 10px 25px; word-break: break-word;">
                                                    <div style="font-family: Montserrat, Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 24px; text-align: left; color: black;">
                                                        <p style="margin: 0;"> Your generous blood donation has helped save lives. You are a true hero! </p>
                                                    </div>
                                                </td>
                                            </tr>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background: #D21B16; background-color: #D21B16; width: 100%;">
                <tbody>
                    <tr>
                        <td>
                            <div style="margin: 0px auto; max-width: 600px;">
